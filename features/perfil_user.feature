...
When eu seleciono o perfil de outro usuario
Then eu sou transferido para a pagina de perfil deste usuario
And eu vejo informações como "Nome", "Foto de perfil", "Bio"

Scenario: Exibir o livro que o usuário esta lendo atualmente
Given eu estou na pagina de perfil de "luisx3@gmail.com"
When eu navego ate a seção "Lendo atualmente"
Then "Titulo","Autor" e "Porcentagem de leitura" sao exibidos nesta seção
...
And minha nova bio "Amante de livros e aventuras literarias" e exibida na pagina de perfil
...
And eu seleciono a opção "Editar Perfil" 
When eu deixo o campo "Bio" vazio And eu salvo as alteracoes 
